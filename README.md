...
在 macOS 上，我一直怀念 Windows 11 自带文本编辑器那种简单、直接、打开就写的感觉，却没有找到一款同时满足“顺手、轻量、免费”的 Markdown 编辑器。于是我让 AI 协助把心里那款小工具做了出来，并决定将它完整开源。
...
- 行首输入 `/` 弹出 Markdown 格式菜单
  - 支持正文、1–3 级标题、无序/有序列表、引用、代码块、分割线和图片
